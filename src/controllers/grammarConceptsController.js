...
//   // Validate concept type against allowed types
//   const allowedTypes = [
//     "part_of_speech", "case", "tense", "voice", 
//     "mood", "gender", "number", "state"
//   ];
  
//   if (!allowedTypes.includes(conceptType)) {
//     return res.status(400).json({ 
//       error: `نوع المفهوم غير صالح. الأنواع المسموح بها: ${allowedTypes.join(', ')}`,
//       message: `Invalid concept type. Allowed types: ${allowedTypes.join(', ')}`
//     });
//   }
...
//   "relatedConcepts": [
//     {
//       "type": "نوع المفهوم ذي الصلة (استخدم فقط واحدة من القيم التالية: part_of_speech, case, tense, voice, mood, gender, number, state)",
...
//             // If type is not a valid enum value, attempt to map it or default to 'case'
...
//               concept.type = typeMapping[concept.type] || 'case';
//             }
//             return concept;
//           });
//         }
...
//   // Validate concept type against allowed types (same as above)
//   const allowedTypes = [
//     "part_of_speech", "case", "tense", "voice", 
//     "mood", "gender", "number", "state"
//   ];
...
//   "relatedConcepts": [
//     {
//       "type": "نوع المفهوم ذي الصلة (استخدم فقط واحدة من القيم التالية بالضبط: part_of_speech, case, tense, voice, mood, gender, number, state)",
//       "name": "اسم المفهوم ذي الصلة",
//       "nameArabic": "الاسم العربي للمفهوم",
