...
//   { name: 'API Configuration', path: '/api/config' },
//   { name: 'Arabic Analysis Status', path: '/api/analysis/status' },
//   { name: 'Arabic Analysis', path: '/api/analysis/analyze', method: 'POST', body: { arabicText: 'مرحبا بالعالم' } },
//   { name: 'Generate Exercises', path: '/api/exercises/generate', method: 'POST', body: { level: 'beginner', type: 'vocabulary', topic: 'greetings', count: 3 } },
//   { name: 'Generate Quiz', path: '/api/quiz/generate', method: 'POST', body: { level: 'beginner', topic: 'daily conversation', questionCount: 5 } }
// ];
...
//     try {
//       const { name, path, method = 'GET', body } = endpoint;
...
//       // Show the full response for GET requests or limited preview for POST requests
//       if (method === 'GET' || response.statusCode !== 200) {
//         console.log(`Response: ${JSON.stringify(response.data, null, 2)}\n`);
//       } else {
//         const responsePreview = JSON.stringify(response.data).substring(0, 150) + '...';
...
//       }
//     } catch (error) {
//       console.error(`❌ Error testing endpoint ${endpoint.name}:`, error.message);
//     }
